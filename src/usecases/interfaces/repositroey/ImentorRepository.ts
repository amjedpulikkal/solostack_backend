...
export interface ImentorRepository {
    ...
    // getAllMentorsWithDate(date:Date):Promise<Imentor[]>
    getMentorProfile(userName:string): Promise<Imentor>
    updateUserPhoto(id:string,photoPath:string):Promise<Imentor>
}
