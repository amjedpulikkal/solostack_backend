...
exports.stripeController = exports.studentCtrl = exports.mentorCtrl = exports.chatCtrl = exports.ChatGroupUseCases = exports.redisDb = exports.logger = exports.nodemailer = void 0;
...
exports.nodemailer = new nodemailer_1.Nodemailer();
...
const studentUsecase = new studentUsecases_1.StudentUsecase(studentRepo, otpRepository, uuid, exports.nodemailer, hashPassword, token, staticFile, reviewRepository, exports.redisDb);
const mentorRepository = new mentorRepository_1.MentorRepository();
const mentorUseCases = new mentorUsecases_1.MentorUseCases(mentorRepository, reviewTimeRepository, otpRepository, uuid, exports.nodemailer, hashPassword, token, staticFile, sharp, reviewRepository, exports.redisDb, socketIo_1.socketEmitEventToUser);
